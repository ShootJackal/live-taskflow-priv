...
const cmdStyles = StyleSheet.create({
  window: { borderRadius: DesignTokens.radius.xl, borderWidth: 0, overflow: "hidden" },
  titleBar: {
    flexDirection: "row",
    alignItems: "center",
  ...
  titleText: { fontSize: 10, letterSpacing: 0.4, marginLeft: 12, flex: 1 },
  sessionMeta: { alignItems: "flex-end", gap: 3 },
  sessionBadge: {
    flexDirection: "row",
    alignItems: "center",
    gap: 4,
  ...
  sessionLabel: { fontSize: 9, fontWeight: "700" as const, letterSpacing: 1 },
  rigCountMini: { fontSize: 10, letterSpacing: 0.4 },
  scrollArea: { maxHeight: 440 },
  scrollContent: { padding: 14, paddingBottom: 10 },
  line: { lineHeight: 21, letterSpacing: 0.3, fontSize: 12 },
  actionRow: {
    flexDirection: "row",
    gap: 10,
    marginTop: 14,
  ...
  actionText: { fontSize: 11, fontWeight: "600" as const, letterSpacing: 0.5 },
});

const guideStyles = StyleSheet.create({
  overlay: { flex: 1, backgroundColor: "rgba(0,0,0,0.5)", justifyContent: "center", alignItems: "center", padding: DesignTokens.spacing.xxxl },
  card: { width: "100%", maxWidth: 400, borderRadius: DesignTokens.radius.xxl, borderWidth: 0, padding: DesignTokens.spacing.xxl },
  cardHeader: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginBottom: 24 },
  cardTitle: { fontSize: 16, fontWeight: "700" as const, letterSpacing: 2 },
  step: { flexDirection: "row", alignItems: "flex-start", gap: 16, paddingVertical: 16 },
  stepNum: { width: 38, height: 38, borderRadius: 14, alignItems: "center", justifyContent: "center" },
  stepNumText: { fontSize: 13, fontWeight: "700" as const },
  stepContent: { flex: 1 },
  stepTitle: { fontSize: 16, fontWeight: "600" as const, marginBottom: 5 },
