...
# EXPO_PUBLIC_GOOGLE_SCRIPT_URL=<single script /exec URL>   # recommended
# Optional split mode:
...
4. Vercel will use the repo’s `vercel.json`: install command `npm install`, build command `npm run vercel-build`, and output directory `dist`.
